...
| `floodfd dpdk` | Bind the NIC (vfio-pci, skipped for Mellanox) + reserve hugepages, then launch DPDK pktgen at the saved target. Drops you at pktgen's prompt — run `start 0` and `set 0 rate <pct>` yourself. |
